...
It is best practice to have at least 3 times the neurons than the number of inputs. I used 3 layers because we had more inputs to process. The unoptimized model only had 2 layers and 80/50 neurons which generated an accuracy score of .725.  With such a low accuracy score, it became apparant that more neurons and layers were necessary. 
